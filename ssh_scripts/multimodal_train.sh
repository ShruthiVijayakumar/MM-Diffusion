...
--use_scale_shift_norm True --num_workers 4 --num_classes 9"

# Modify --devices to your own GPU ID
TRAIN_FLAGS="--lr 0.0001 --batch_size 4
--devices 0,1,2,3,4,5,6,7 --log_interval 100 --save_interval 10000 --use_db False --schedule_sampler loss-second-moment --class_cond True"
...
DATA_DIR="/home/vijayaku/MM-Diffusion/datasets/landscape/landscape/train"
OUTPUT_DIR="/home/vijayaku/MM-Diffusion-conditional/MM-Diffusion/output_conditional_8k"
NUM_GPUS=8
